...
//	cout << "@summarizeAns < ..\\data\\secret\\g" << groupNumber << "\\railway." << (number < 10 ? "0" : "") << number << ".ans" << endl;
	cout << "set /p texte=< ..\\data\\secret\\g" << groupNumber << "\\railway." << (number < 10 ? "0" : "") << number << ".ans" << endl;
	cout << "echo %texte%" << endl;
}
