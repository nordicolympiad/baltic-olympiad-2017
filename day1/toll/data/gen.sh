...
echo "grading: custom
grader_flags: all 8" > secret/g3/testdata.yaml
echo "grading: custom
grader_flags: all 31" > secret/g4/testdata.yaml
echo "grading: custom
grader_flags: all 44" > secret/g5/testdata.yaml
...
./generator.py -n 1000 -k 1 -m 0.98 -o $O -seed 82 -forceA > $DR/$PROBLEMNAME.$G.06.in
./generator.py -n 1000 -k 2 -m 0.9 -o $O -seed 92 -forceA > $DR/$PROBLEMNAME.$G.07.in
...
./generator.py -n $NE -k 2 -m 1.0 -o $O -seed 182 -forceA > $DR/$PROBLEMNAME.$G.11.in
./generator.py -n $NE -k 3 -m 0.5 -o $O -seed 192 -forceA > $DR/$PROBLEMNAME.$G.12.in
...
NO="49999"
O="100"
./generator.py -n 10 -k 1 -m 0.89 -o 10 -seed 232  > $DR/$PROBLEMNAME.$G.01.in
./generator.py -n 10 -k 2 -m 0.89 -o 10 -seed 132  > $DR/$PROBLEMNAME.$G.02.in
./generator.py -n 10 -k 3 -m 0.89 -o 10 -seed 332  > $DR/$PROBLEMNAME.$G.03.in
./generator.py -n 10 -k 4 -m 0.89 -o 10 -seed 432  > $DR/$PROBLEMNAME.$G.04.in
./generator.py -n 10 -k 5 -m 0.89 -o 10 -seed 532  > $DR/$PROBLEMNAME.$G.05.in
./generator.py -n 1000 -k 1 -m 0.97 -o $O -seed 823  > $DR/$PROBLEMNAME.$G.06.in
./generator.py -n 1000 -k 2 -m 0.96 -o $O -seed 923  > $DR/$PROBLEMNAME.$G.07.in
./generator.py -n 1000 -k 5 -m 0.94 -o $O -seed 932  > $DR/$PROBLEMNAME.$G.08.in
./generator.py -n 1000 -k 4 -m 0.89 -o $O -seed 932  > $DR/$PROBLEMNAME.$G.09.in

./generator.py -n $NE  -k 1 -m 0.999 -o $O -seed 13  > $DR/$PROBLEMNAME.$G.10.in
./generator.py -n $NE  -k 2 -m 0.95 -o $O -seed 23  > $DR/$PROBLEMNAME.$G.11.in
./generator.py -n $NE  -k 3 -m 0.9 -o $O -seed 123  > $DR/$PROBLEMNAME.$G.12.in

./generator.py -n $NO -k 3 -m 1.0 -o $O -seed 17  > $DR/$PROBLEMNAME.$G.13.in
./generator.py -n $NE  -k 3 -m 0.75 -o $O -seed 93  > $DR/$PROBLEMNAME.$G.14.in
...
./generator.py -n $NO -k 3 -m 1.0 -o $O -seed 173  > $DR/$PROBLEMNAME.$G.13.in
./generator.py -n $NE  -k 3 -m 0.75 -o $O -seed 193  > $DR/$PROBLEMNAME.$G.14.in
