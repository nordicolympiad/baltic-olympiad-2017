...
\begin{description}
    ...
    \item{\textbf{Group 3: 8 points}} $O \leq 100$   % Repeated DP
    \item{\textbf{Group 4: 31 points}} $O \leq 3\,000$         % $O(K^{3/2} O\sqrt N)$
    \item{\textbf{Group 5: 44 points}} No further restrictions. % $O(K^3(N+KO\log(N/K)))$
\end{description}
